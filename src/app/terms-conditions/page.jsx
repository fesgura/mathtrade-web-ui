...
const TermConditionsPage = () => {
  return (
    <article className="relative fade-in-up">
      <div className="py-xs-5 px-xs-6 p-4">
        ...
        <ol className="tyc-ul">
          <li>
            Los cambios finales son un compromiso. Cada juego ofrecido o deseado
            puede transformarse en un cambio definitivo. Analizá y revisá bien
            tus decisiones antes de que se conozcan los resultados definitivos.
            Como consejo, te recomendamos preguntarte si estás conforme con el
          ...
          <li>
            ...
            por quien recibe cada juego. Pero a no preocuparse porque se
            realizan envíos compartidos para abaratar costos. Es probable que en
            algunos casos el envío se realice en dos tramos, pasando por CABA
          ...
          <li>
            ...
            disgustos con los cambios finales. Prestá atención a las categorías
            de estados de los juegos y elegí la más adecuada. Ante alguna duda,
            te recomendamos elegir siempre la más baja. Del mismo modo, comprobá
            que estés eligiendo la versión y el idioma correcto de tus juegos.
            <br />
            La BGG es solo una ayuda, consignar los datos correctos son tu
            responsabilidad absoluta.
          </li>
          <li>
            En el MT se cambian juegos usados (mayoritariamente). Pueden existir
          ...
          <li>
            ...
            MT lo hacemos por amor y pasión a esta afición, no tenemos
            beneficios económicos de ningún tipo y estamos felices de colaborar,
            pero tampoco somos el servicio de atención al cliente de Aduana (?)
            Somos mejores (?){" "}
          </li>
        </ol>
