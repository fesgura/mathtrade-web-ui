const listIcons = {
  ...
  "bgg-full": (
    <path
      fill="currentColor"
      d="m19.17 4.95-.91 7.28 1.23 1.19-2.86 6.72-8.24 3.04-3.88-9.71 1.3-1.26-.77-6.2L19.12.82l-2.17 4.74 2.22-.6Z"
    />
  ),
  location: (
    <path
  ...
  newUser: (
    <path
      fill="currentColor"
      d="M18.25 13.5v-3h-3v-1h3v-3h1v3h3v1h-3v3zM9 11.384q-1.237 0-2.119-.88T6 8.383t.881-2.118T9 5.385t2.119.88t.881 2.12t-.881 2.118T9 11.385m-7 7.23V16.97q0-.619.36-1.158q.361-.54.97-.838q1.416-.679 2.834-1.018q1.417-.34 2.836-.34t2.837.34t2.832 1.018q.61.298.97.838q.361.539.361 1.158v1.646z"
    />
  ),
  share: (
    <path
