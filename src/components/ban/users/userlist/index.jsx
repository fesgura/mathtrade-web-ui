...
const BanUserList = ({ onClose }) => {
  const { userList, userBans, setUserBans, loading, error, order, setOrder } =
    useBanUserList();
  ...
  return (
    <div className="relative min-h-[260px]">
      ...
      <table className="w-full max-w-lg border border-gray-100 shadow border-spacing-0 text-sm mx-auto">
